...
import time
import pandas
import tsp_mcvfz472gty6_pb2 as tsp_mcvfz472gty6_pb2
...
class apiHelper:
  ...
  def Post(self, sr):
    ...
    with open('reqeust.bin',"wb") as file:
       file.write(p.SerializeToString())
    ...
    if post_resp.status_code != 200:
        ...
        if post_resp.status_code == 405 and len(post_resp.content) == 0:
          ...
          sys.exit(f'Unexpected http error code: {post_resp.status_code} \n {post_resp.content.decode("utf-8")}')
    else: 
